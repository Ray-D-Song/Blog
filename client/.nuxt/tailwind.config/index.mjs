...
import future from "#build/tailwind.config/future.mjs"
...
const config = { theme, corePlugins, plugins, content, darkMode, future, safelist, variants, presets, prefix, important, separator, blocklist }
export { config as default, theme, corePlugins, plugins, content, darkMode, future, safelist, variants, presets, prefix, important, separator, blocklist }